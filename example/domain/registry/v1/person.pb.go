...
type Person_Client struct {
	...
	//
	//	*Person_Client_Subsc1
	//	*Person_Client_Subsc2
	//	*Person_Client_Subsc3
	Role isPerson_Client_Role `protobuf_oneof:"role"`
}
...
func (m *Person_Client) GetRole() isPerson_Client_Role {
	if m != nil {
		return m.Role
	}
	return nil
...
func (x *Person_Client) GetSubsc1() string {
	if x, ok := x.GetRole().(*Person_Client_Subsc1); ok {
		return x.Subsc1
	}
	return ""
}

func (x *Person_Client) GetSubsc2() string {
	if x, ok := x.GetRole().(*Person_Client_Subsc2); ok {
		return x.Subsc2
	}
	return ""
}

func (x *Person_Client) GetSubsc3() string {
	if x, ok := x.GetRole().(*Person_Client_Subsc3); ok {
		return x.Subsc3
	}
	return ""
}
...
type isPerson_Client_Role interface {
	isPerson_Client_Role()
}

type Person_Client_Subsc1 struct {
	Subsc1 string `protobuf:"bytes,4,opt,name=subsc1,proto3,oneof"`
}

type Person_Client_Subsc2 struct {
	Subsc2 string `protobuf:"bytes,5,opt,name=subsc2,proto3,oneof"`
}

type Person_Client_Subsc3 struct {
	Subsc3 string `protobuf:"bytes,6,opt,name=subsc3,proto3,oneof"`
}

func (*Person_Client_Subsc1) isPerson_Client_Role() {}

func (*Person_Client_Subsc2) isPerson_Client_Role() {}

func (*Person_Client_Subsc3) isPerson_Client_Role() {}
...
var file_registry_v1_person_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x22, 0x99, 0x08, 0x0a, 0x06, 0x50, 0x65, 0x72, 0x73,
	...
	0x61, 0x6e, 0x61, 0x67, 0x65, 0x73, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x1a, 0xa8, 0x03,
	...
	,
	...
	0x42, 0x06, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x1a, 0xe0, 0x01, 0x0a, 0x07, 0x41, 0x64, 0x64,
	...
	0x6d, 0x62, 0x65, 0x72, 0x12, 0x23, 0x0a, 0x0a, 0x61, 0x64, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	0x61, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0a, 0x61, 0x64, 0x64, 0x69,
	0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x88, 0x01, 0x01, 0x12, 0x1a, 0x0a, 0x08, 0x6c, 0x6f, 0x63,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x42, 0x0d, 0x0a, 0x0b,
	0x5f, 0x61, 0x64, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x42, 0x06, 0x0a, 0x04, 0x74,
...
func file_registry_v1_person_proto_init() {
	...
	file_registry_v1_person_proto_msgTypes[3].OneofWrappers = []interface{}{
		...
		(*Person_Client_Subsc1)(nil),
		(*Person_Client_Subsc2)(nil),
		(*Person_Client_Subsc3)(nil),
	}
...
func (e *Person_Client) LoadMap(m map[string]interface{}) {
	...
	if _opt, ok := m["Role"].(map[string]interface{}); ok {
	}
}
